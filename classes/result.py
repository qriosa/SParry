class Result(object):
	"""
	function: to store the result of different algorithm.

	parameters:
		dist: the shortest path distance answer for algorithm.
		timeCostNum: a float data of time cost of getting the answer, so it can use to calculate.
		timeCost: a str data of time cost of getting the answer.
		memoryCost: memory cost of getting the answer.
