...
def test(filename = None, n = 1000, m = 5000, l = 1, r = 20):
	...
	for i in range(len(method)):
		...
		ans.append(main(graph = CSR, graphType = 'CSR', method = method[i], useCUDA = useCUDA[i], pathRecordBool = True, srclist = srclist, block=(512, 2, 1), grid = (1, 1)))
...
if __name__ == '__main__':
	...
	test(filename = filename, n = 8, m = 15, l = 3, r = 30)